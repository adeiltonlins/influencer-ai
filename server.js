...
app.get('/api/health', (_req, res) => res.json({ ok:true, service:'influencer-ai', version:'0.3.0', geminiConfigured:Boolean(process.env.GEMINI_API_KEY) }));
